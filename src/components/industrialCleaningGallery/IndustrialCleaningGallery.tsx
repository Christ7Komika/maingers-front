        ...
        <div className="industriel-cleaning-material-content-list">
          <div className="industriel-cleaning-material-content-list-right">
            <p>
              ...
              distribution hélicoïdal pour un fonctionnement plus silencieux et
              plus puissant
            </p>
            <p>
              <span>
            ...
            <p>
              ...
              suppression et une jauge de pression/vide composée (30 po HGg à 15
              psig)
            </p>
            <p>
              <span>
              ...
              Maintenance et fonctionnement - les unités ont effectué des années
              de service fiable avec un minimum de maintenance
            </p>
          </div>
          ...
          <div className="industriel-cleaning-material-content-list-left">
            <p>
              ...
              Flexible - grâce à leur conception modulaire à deux composants, la
              disposition des systèmes 50 HP et 100 HP peut être organisée pour
            ...
            <p>
              ...
              Entretien - tous les systèmes ont un passage pour un hommes de 18
              pouces pour un néttoyage facile
            </p>
            <p>
              <span>
                <FaCheckCircle />
              </span>
              Capacité - plus puissante qu'un camion aspirateur ordinaire facile
              à utiliser
            </p>
            <p>
              <span>
